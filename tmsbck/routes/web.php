...
//Route::get('/home', 'HomeController@index')->name('home');
 ...
 Route::group(['middleware' => ['adminlogin']], function () {
    ...
    //teacherattend
    Route::get('/admin/add-attendenceteach','AttendenceController@markteacher');
    Route::match(['get', 'post'], '/check-attendenceteach','AttendenceController@getteacheratt');
     


    //payments
    Route::match(['get', 'post'], '/admin/add-payment','PaymentsController@add'); 
    Route::match(['get', 'post'], '/admin/add-paymentinattend/{id}/{class}','PaymentsController@addpaymentattend'); 
    Route::match(['get', 'post'], '/admin/add-paymentnew/{id}','PaymentsController@new');
    Route::match(['get', 'post'], '/admin/add-billpay','PaymentsController@addpayment'); 

    Route::match(['get', 'post'], '/admin/add-paymentmon/{id}','PaymentsController@mon');
    Route::match(['get', 'post'], '/admin/add-billpaymon','PaymentsController@addpaymentmon');
    ...
    Route::match(['get', 'post'], '/add-tempmon','PaymentsController@UpdateMonPay'); //monthly
     Route::match(['get', 'post'], '/add-tempreg','PaymentsController@UpdateRegPay'); //newregistet
      Route::match(['get', 'post'], '/add-temp','PaymentsController@getAjax');
    //view registration fees
    Route::get('/admin/view-paymentreg','PaymentsController@viewPaymentsReg');
    ...
    Route::match(['get', 'post'], '/admin/delete-feestemp/{id}','PaymentsController@deletefees');
    
   
    Route::get('/admin/view-payment','PaymentsController@viewPayments');
    Route::match(['get', 'post'], '/admin/view-morepaym/{id}','PaymentsController@viewPaymentsmore');


    //payment Category
    Route::match(['get', 'post'], '/admin/add-paymentcat','PaymentsController@addCat');
    Route::match(['get', 'post'], '/admin/delete-paymentcat/{id}','PaymentsController@delete');
    Route::match(['get', 'post'], '/admin/edit-paymentcat/{id}','PaymentsController@edit'); 
   ...
   Route::get('/admin/view-payments','PaymentsController@view');
    ...
    Route::get('/json-class','PaymentsController@class');
    Route::get('/json-attribute','PaymentsController@attribute');
     Route::get('/json-attributepaytype','PaymentsController@attributepaytype');
