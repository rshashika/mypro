          ...
          <li @if (preg_match("/payment/i", $url)) class="menu-open nav-item has-treeview" @else class="nav-item has-treeview"  @endif>
            <a href="#" class="nav-link">
             ...
             <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ url('/admin/view-paymentreg') }}" @if (preg_match("/view-paymentreg/i", $url)) class="nav-link active" @else class="nav-link"   @endif>
                  <i class="far fa-circle nav-icon"></i>
             ...
             {{--  <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="{{ url('/admin/view-payment') }}" @if (preg_match("/view-payment/i", $url)) class="nav-link active" @else class="nav-link"   @endif>
                  <i class="far fa-circle nav-icon"></i>
                  <p>View</p>
                </a>
              </li>
