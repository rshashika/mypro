...
<script src="{{ asset('plugins/select2/js/select2.full.min.js') }}"></script>
   ...
   <form enctype="multipart/form-data" class="form-inline" method="post" action="{{ url('admin/view-attendence-report') }}" name="add_Place" id="add_Place" >  {{ csrf_field() }}
                 ...
                 <!-- <div class="row">
                  ...
                  <div class="col">
                   ...
                   <select class="select2 form-control"  name="student"  required >
                  ...
                  <div class="form-group">
                   ...
                   <select class="select2 form-control"  name="student" id="student"   >
                    <option value="" >Student Ad Num </option>
                  @foreach($students as $stu )
                    <option value="{{$stu->admission_num}}"@if(!empty($student) && $stu->admission_num==$student) selected @endif>{{$stu->admission_num}}-{{ $stu->first_name." ".$stu->last_name}}</option>
                     @endforeach
               ...
               <option value="" >Student Class </option>
                   @foreach($classes as $tution )
                    <option value="{{$tution->id}}"@if(!empty($classid) && $tution->id==$classid) selected @endif>Gr {{$tution->grade}} - {{$tution->subject}} - {{$tution->first_name}}</option>
                     @endforeach
                   </select>
                  ...
                  <input type="button" onclick="location.href='{{ url('admin/view-attendence-report') }}';" id="tempadd" value="Reset " class="btn btn-danger btn-sm">
                   </form>
                   </div>
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       <td style="text-align: center;"> {{ $class->first_name. " " .$class->last_name }} </td>
                                            <td style="text-align: center;">{{ $class->subject }}</td>
